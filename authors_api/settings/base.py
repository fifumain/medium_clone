...
# Our own link to admin panel (defined for urls.py)
...
# All requests should begin woth api/ in ur;, in case if not - request will not be handled
CORS_URLS_REGEX = r"^api/.*$"

# Our own user model in core_apps/user/models.py
...
# Some registrations etc. settings
